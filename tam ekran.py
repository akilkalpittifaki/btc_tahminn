...
class BitcoinPredictorApp(QMainWindow):
    def __init__(self):
        ...
        # Pencere başlığı ve boyutunu ayarla
        self.setWindowTitle("Bitcoin Tahmin Uygulaması")
        
        # Tam ekran yapmak için:
        self.showMaximized()  # Tam ekran ama görev çubuğu görünür
        # veya
        # self.setWindowState(Qt.WindowFullScreen)  # Tamamen tam ekran (görev çubuğu gizli)
        
        # Ya da ekranın belirli bir yüzdesini kaplayacak şekilde:
        # width = int(screen.width() * 0.8)  # Ekran genişliğinin %80'i
        # height = int(screen.height() * 0.8)  # Ekran yüksekliğinin %80'i
        # self.setGeometry((screen.width() - width) // 2,  # Ekranın ortasında
        #                  (screen.height() - height) // 2,
        #                  width,
        #                  height)
        
        # Grafik boyutunu büyüt
        self.figure, self.ax = plt.subplots(figsize=(16, 10))  # Grafik boyutunu artır
        ...
        self.date_input.setFixedWidth(200)  # Input genişliğini sabitle
        date_layout.addWidget(self.date_label)
        date_layout.addWidget(self.date_input)
        
        self.predict_button = QPushButton("Tahmin Et")
        self.predict_button.clicked.connect(self.make_prediction)
        self.predict_button.setFixedWidth(200)  # Buton genişliğini sabitle
        ...
        self.results_text.setMinimumWidth(400)  # Sonuç paneli minimum genişliği
        
        splitter.addWidget(left_widget)
        splitter.addWidget(self.results_text)
        
        # Splitter oranlarını ayarla (70% grafik, 30% sonuçlar)
        ...
        font = self.font()
        font.setPointSize(10)  # Genel font boyutu
        self.setFont(font)
        
        # Grafik fontlarını büyüt
